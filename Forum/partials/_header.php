...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true) {
       echo ' <form class="d-flex" role="search" method="get" action="search.php">
        ...
        <p class="text-light my-0 mx-2 ">Welcome '.$_SESSION['useremail'].'</p>
         <a href="partials/_logout.php" class="btn btn-success ml-2 mx-2" type="button" data-bs-target="#loginModal">LogOut</a>
  ...
  echo '
        ...
        <button class="btn btn-outline-success mx-2" type="submit">Search</button>
        <button class="btn btn-success ml-2" type="button" data-bs-toggle="modal" data-bs-target="#loginModal">LogIn</button>
